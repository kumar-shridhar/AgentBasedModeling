...
to setup
  ...
  ;; create two turtles (nodes) and space them out and set the colors to red and green
  create-turtles 1 [
    set color red
    fd 5
  ]
  ...
  set colors-set n-of Agent-color [red blue green cyan magenta yellow gray]; choose agent colors from 0-7
  reset-ticks
end

to go
  if count turtles > num-of-agents [ stop ]
